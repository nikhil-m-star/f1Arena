...
export default async function Home() {
  ...
  return (
    <div className="flex-1 flex flex-col">
      {/* Hero Header Section */}
      <section className="relative overflow-hidden border-b border-zinc-800/60 bg-zinc-950 py-16 px-6 sm:py-24 sm:px-8 carbon-bg">
        <div className="absolute inset-0 bg-gradient-to-t from-zinc-950 via-zinc-950/60 to-transparent"></div>
        <div className="relative mx-auto max-w-5xl text-center">
          <span className="inline-flex items-center gap-1.5 rounded-full bg-red-950/40 px-3 py-1 text-xs font-semibold text-f1-red border border-red-500/20 mb-4 animate-pulse">
          ...
          {!user && (
            <div className="mt-8 flex justify-center gap-4">
              <SignInButton mode="modal">
                <button className="px-6 py-2.5 rounded font-bold text-sm text-white bg-f1-red hover:bg-red-500 transition shadow-[0_0_15px_rgba(225,6,0,0.4)] cursor-pointer">
                  Start Predicting
                </button>
              </SignInButton>
              <Link href="/calendar" className="px-6 py-2.5 rounded font-bold text-sm text-zinc-300 bg-zinc-900 border border-zinc-800 hover:bg-zinc-800 transition cursor-pointer">
                View Calendar
              </Link>
            </div>
          )}
      ...
      <section className="mx-auto w-full max-w-5xl px-6 py-12 flex-1 grid gap-8 md:grid-cols-3">
        ...
        <div className="md:col-span-2 space-y-8">
          ...
          {upcomingRace ? (
            <div className="glass-card rounded-xl p-6 relative overflow-hidden">
              <div className="absolute top-0 right-0 h-1 bg-gradient-to-r from-f1-red to-orange-500 w-full"></div>
              
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div>
                  <span className="text-xs font-bold uppercase tracking-widest text-f1-red">Upcoming Grand Prix</span>
                ...
                <div className="flex flex-col items-start sm:items-end gap-1">
                  <span className="text-[10px] font-bold text-zinc-500 uppercase tracking-wider flex items-center gap-1">
                    <Clock className="w-3 h-3 text-f1-red" /> Quali Lock Countdown
                  </span>
          ...
          {lastCompletedRace && (
            <div className="glass-card rounded-xl p-6">
              ...
              <div className="grid grid-cols-3 gap-4 mt-6 text-center">
                <div className="bg-zinc-900/60 p-3 rounded border border-zinc-800/40">
              ...
              <div className="mt-4 flex items-center justify-between text-sm text-zinc-400">
                ...
                <Link href={`/races/${lastCompletedRace.id}`} className="text-f1-red hover:underline font-semibold flex items-center gap-0.5 text-xs">
        ...
        <div className="space-y-6">
          ...
          {user ? (
            <div className="glass-card rounded-xl p-6 border-zinc-800/80">
              <div className="flex items-center gap-3">
                <div className="h-10 w-10 rounded bg-red-950/60 border border-f1-red/30 flex items-center justify-center text-f1-red">
              ...
              <div className="grid grid-cols-2 gap-4 mt-6">
                ...
                <div>
                  ...
                  <div className="text-2xl font-black text-f1-red">#{userStats.globalRank}</div>
                </div>
                <div>
              ...
              <div className="mt-6 space-y-2">
                <Link
                  href="/profile"
                  className="w-full text-center block text-xs bg-zinc-900 border border-zinc-800 hover:bg-zinc-800 transition py-2 rounded font-bold text-zinc-300 cursor-pointer"
                >
            ...
            <div className="glass-card rounded-xl p-6 text-center border-zinc-800/80">
              <Sparkles className="w-10 h-10 text-f1-red mx-auto mb-3" />
          ...
          <div className="glass-card rounded-xl p-6 space-y-4">
            ...
            <Link
              href="/arenas"
              className="flex items-center justify-between p-3 rounded bg-zinc-900/60 border border-zinc-800/50 hover:bg-zinc-800/60 transition group cursor-pointer"
            >
